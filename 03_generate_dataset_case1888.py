...
class SamplingAgent(scip.Branchrule):
    ...
    def branchexeclp(self, allowaddcons):
        ...
        v_fea_Pinfo = np.concatenate([v_fea['values'], self.pinfo_buffer], axis=1)  # (N, R+11)
        v_fea_dict = {
            'names': v_fea['names'],
            'values': v_fea_Pinfo, }
...
if __name__ == '__main__':
    ...
    base_dir = r"D:/LiJiamigFile/CAMBranch-ljmdata/data/instances/case1888-v1"
    finished_dir = r"D:/LiJiamigFile/CAMBranch-ljmdata/KIDA_data/samples/case1888_finished_milp.csv"
