...
if __name__ == "__main__":
    ...
    if args.problem == 'case2383':

        #                    P6
        # user_selected_ids = [2454 ]

        # #                     P1    P2    P3    P4    P5    P6    P7    P8    P9    P10
        # user_selected_ids = [2407, 2423, 2425, 2428, 2440, 2454, 2481, 2483, 2498, 2511, ]
        #                   P11    P12    P13   P14   P15   P16  P17    P18   P19   P20
        user_selected_ids = [2417, 2427, 2437, 2447, 2457, 2467, 2507, 2517, 2527, 2537, ]
        instances += [{'type': f'{args.gpu}(-1:cpu,others:gpu)', 'path': f"D:/LiJiamigFile/CAMBranch-ljmdata/data/instances/case2383-CSG2024.12.1-v2/test_milp/case2383_{i}/case2383_{i}.lp"} for i in user_selected_ids]
            ...
            if policy['name'] not in loaded_models:
                ...
                if policy['name'] == 'gcnn' or policy['name'] == 'gcnn_0.1':
                    ...
                    model.load_state_dict(
                        torch.load(
                            r"D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_0.1_gasse\gcnn_0.1_gasse.pkl",
                            weights_only=True)
                    )
                    print(
                        r"load model 1: D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_0.1_gasse\gcnn_0.1_gasse.pkl")
                    ...
                    model.load_state_dict(
                        torch.load(
                            r"D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_0.1_huake\gcnn_0.1_huake.pkl",
                            weights_only=True)
                    )
                    print(
                        r"load model 2: D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_0.1_huake\gcnn_0.1_huake.pkl")
                    ...
                    model.load_state_dict(
                        torch.load(
                            r"D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_aug\NoPgraph\gcnn_aug_1.pkl",
                            weights_only=True)
                    )
                    print(
                        r"load model 3: D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_aug\NoPgraph\gcnn_aug_1.pkl")
                    ...
                    model.load_state_dict(
                        torch.load(
                            r"D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_aug\PGNN\gcnn_aug_1.pkl",
                            weights_only=True)
                    )
                    print(
                        r"load model 4: D:\LiJiamigFile\CAMBranch-ljmdata\KIDA_log\case2383\gcnn_aug\PGNN\gcnn_aug_1.pkl")
